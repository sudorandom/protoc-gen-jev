...
class ContractServiceClient:
    ...
    def client(self) -> TypeSafeClient:
        ...
        return self._client
    def build_evaluate_questions(self) -> dict[str, Any]:
    ...
    def evaluate(self, req: _pb0.EvaluateRequest) -> _pb1.EvaluateResponse:
    ...
    def build_external_questions(self) -> dict[str, Any]:
    ...
    def external(self, req: _pb2.ExternalRequest) -> _pb3.ExternalResponse:
    ...
    def build_nested_questions(self) -> dict[str, Any]:
        return _questions(json.loads("[{\"name\":\"accepted\",\"type\":\"noul\",\"instructions\":\"Evaluate accepted\",\"field\":\"accepted\",\"kind\":\"bool\",\"threshold\":0.5}]"))
    def nested(self, req: _pb4.Container.NestedRequest) -> _pb5.Container.NestedResponse:
